...
Finalmente, se realizaron las conexiones en la protoboard y para poder ver las señales tanto de entrada como de salida, y así poder compararlas, se conectó el generador de señales, la fuente simétrica y un osciloscopio en las terminales correspondientes.

### **$\color{#C0C0C0}\text{Amplificador no inversor}$**
Para este caso se siguió el diagrama que se muestra en la [Figura 3](#fig-no_inversor)
